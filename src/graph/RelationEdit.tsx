  ...
  useEffect(() => {
   ...
   function properties() {
    return <>
      ...
      <IconButton
          component="span"
          color="inherit" onClick={addProperty}>
        <AddIcon/>
      </IconButton>
    ...
    <div className={classes.content}>
      <FormGroup aria-label="position" row>
        ...
        <FormControlLabel
            ...
            labelPlacement="end"
            label="Multiple"
            control={<Checkbox checked={value.multiple}
        ...
        <FormControlLabel
            ...
            labelPlacement="end"
            label="Primary"
            control={<Checkbox checked={value.primary}
                               onChange={(event: any, clicked: boolean) => {
        ...
        <FormControlLabel
            ...
            label="Domain"
            control={
              <DomainSelect domains={props.domains} valueDomainIds={value.domainIds} updateDomains={updateDomain}/>
            }
        />
        {properties()}
      </FormGroup>
