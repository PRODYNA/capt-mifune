...
export const DomainListEntry = (props: DomainListEntryProps) => {
  ...
  function executeUpdate() {
    graphService.domainPut(props.domain.id,
        {...props.domain, name: name, rootNodeId: rootNodeId}
    )
  ...
  >
    <div className={classes.buttons}>
      ...
      <IconButton size={"small"} onClick={() => {
        graphService.domainDelete(props.domain.id)
    ...
    <form className={classes.values} onSubmit={e => {
      executeUpdate();
      e.preventDefault()
    }
    }>
